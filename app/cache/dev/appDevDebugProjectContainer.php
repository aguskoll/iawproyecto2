...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.areasegura' => 'getSecurity_Firewall_Map_Context_AreaseguraService',
            ...
            'security.user_checker.areasegura' => 'getSecurity_UserChecker_AreaseguraService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'db_com109', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a3cc462142227867a8f74b9987db74b996282a17237494f9b6d51c3d557e25f7');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Security\Authentication\Handler\LoginSuccessHandler A UserBundle\Security\Authentication\Handler\LoginSuccessHandler instance.
     */
    protected function getLoginSuccessHandlerService()
    {
        return $this->services['login_success_handler'] = new \UserBundle\Security\Authentication\Handler\LoginSuccessHandler($this->get('router'), $this->get('security.context'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.areaSegura' => NULL)), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.areasegura' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_AreaseguraService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/editor');
        ...
        $j->add($h, array(0 => 'ROLE_EDITOR', 1 => 'ROLE_ADMIN'), NULL);
        $j->add($i, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);

        $k = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $l = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $k, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($k, 'homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
        ...
        $m->setOptions(array('login_path' => 'loginForm', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $n = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $k, 'loginForm', false);

        return $this->services['security.firewall.map.context.areasegura'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.users')), 'areaSegura', $a, $c), 2 => $l, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'areaSegura', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('login_success_handler'), array('login_path' => 'loginForm', 'use_referer' => false, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path'), 'areaSegura'), $m, array('check_path' => 'loginCheck', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $f, 'areaSegura', $n, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '573d15381528f5.61856709', $a, $f), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'areaSegura', $n, NULL, NULL, $a, false));
    }
    ...
    /**
     * Gets the 'security.user_checker.areasegura' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_AreaseguraService()
    {
        return $this->services['security.user_checker.areasegura'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9862ce0c2856e6a706bff0877e7e1cdd072efe9f');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.users'), $this->get('security.user_checker.areasegura'), 'areaSegura', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('573d15381528f5.61856709')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('areaSegura', 'logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.user.provider.concrete.users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'UserBundle:User', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '9862ce0c2856e6a706bff0877e7e1cdd072efe9f',
            ...
            'kernel.secret' => '9862ce0c2856e6a706bff0877e7e1cdd072efe9f',
